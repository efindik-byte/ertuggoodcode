...
public class CommandSwerveDrivetrain extends TunerSwerveDrivetrain implements Subsystem {
    ...
    // Fallback PathPlanner robot config (used if GUI settings file is missing).
    private static final double kRobotMassKg = 50.0;
    private static final double kRobotMoiKgM2 = 6.0;
    private static final double kWheelRadiusMeters = 0.0508; // 2 inches
    private static final double kWheelCof = 1.2;
    private static final double kDriveCurrentLimitAmps = 120.0;
    ...
    private void configureAutoBuilder() {
        try {
            final RobotConfig config = loadRobotConfig();
            ...
            DriverStation.reportError("[AUTO] Failed to configure PathPlanner AutoBuilder", ex.getStackTrace());
        }
    }
    ...
    private RobotConfig loadRobotConfig() {
        try {
            ...
            DriverStation.reportWarning(
                "[AUTO] PathPlanner GUI settings missing; using code fallback robot config",
                false
            );
            final ModuleConfig moduleConfig = new ModuleConfig(
                kWheelRadiusMeters,
                frc.robot.generated.TunerConstants.kSpeedAt12Volts.in(MetersPerSecond),
                kWheelCof,
            ...
            return new RobotConfig(
                ...
                kRobotMoiKgM2,
                moduleConfig,
                new Translation2d(kHalfTrackMeters, kHalfTrackMeters),   // FL
                new Translation2d(kHalfTrackMeters, -kHalfTrackMeters),  // FR
                new Translation2d(-kHalfTrackMeters, kHalfTrackMeters),  // BL
                new Translation2d(-kHalfTrackMeters, -kHalfTrackMeters)  // BR
            );
        }
    }
    ...
    private void updateVisionPoseEstimate() {
        ...
        LimelightHelpers.SetRobotOrientation(kLimelightName, yawDeg, 0, 0, 0, 0, 0);
        ...
        if (Math.abs(getPigeon2().getAngularVelocityZWorld().getValueAsDouble()) > kMaxGyroRateForVisionDps) {
            return;
        }
